#!/usr/bin/env python3
"""Unit tests for worker input validation without external tool dependencies."""
...
class TestWorker(unittest.TestCase):
    ...
    @patch("modules.worker.worker.subprocess.run")
    def test_validate_tool(self, mocked_run):
        mocked_run.return_value.returncode = 0
        self.assertTrue(self.worker._validate_tool("safe-tool")[0])
